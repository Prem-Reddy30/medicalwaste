...
const firebaseConfig = {
  ...
  authDomain: "medical-waste-xxxxx.firebaseapp.com",
  projectId: "medical-waste-xxxxx",
  storageBucket: "medical-waste-xxxxx.appspot.com",
    ...
    return (
      <div className={`min-h-screen ${isDarkMode ? 'dark bg-gray-900' : 'bg-gray-50'} flex items-center justify-center`}>
        ...
        >
          ...
          <GoogleLogin onLogin={handleLogin} isDarkMode={isDarkMode} />
        </motion.div>
      </div>
    );
  }
