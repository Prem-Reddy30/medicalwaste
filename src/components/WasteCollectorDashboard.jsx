...
const WasteCollectorDashboard = ({ isDarkMode }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className={`p-4 rounded-lg ${isDarkMode ? 'bg-gray-700' : 'bg-green-50'}`}>
        <p className={isDarkMode ? 'text-white' : 'text-green-900'}>
      ...
      >
        {activeTab === 'dashboard' && (
          <TestComponent title="Waste Collector Dashboard" isDarkMode={isDarkMode} />
        )}
