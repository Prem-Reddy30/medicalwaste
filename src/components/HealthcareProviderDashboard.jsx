...
const HealthcareProviderDashboard = ({ isDarkMode }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className={`p-4 rounded-lg ${isDarkMode ? 'bg-gray-700' : 'bg-red-50'}`}>
        <p className={isDarkMode ? 'text-white' : 'text-red-900'}>
      ...
      >
        {activeTab === 'dashboard' && (
          <TestComponent title="Healthcare Provider Dashboard" isDarkMode={isDarkMode} />
        )}
